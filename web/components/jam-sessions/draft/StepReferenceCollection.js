...
const StepReferenceCollection = ({ disabled, jamSession, onChangeCollection, onLoadQuestions }) => {
    ...
    const { data: jamSessionQuestions, error: errorsJamSessionQuestions } = useSWR(
    ...
    return (
        <Loading
            loading={!collections}
            errors={[errorCollection, errorsJamSessionQuestions, errorCollectionQuestions]}
        >
