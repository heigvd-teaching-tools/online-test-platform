      ...
      >
        <div
          className={`${resizePanelStyles.panelResizable} ${
            width.left === 100 ? ` ${resizePanelStyles.magnetic}` : ''
          }`}
        ...
        <div
          className={`${resizePanelStyles.panelResizable} ${
            width.center === 0 ? ` ${resizePanelStyles.magnetic}` : ''
          }`}
          style={{ maxWidth: `${width.center}%`, width: `${width.center}%` }}
        >
          {centerPanel}
        </div>
        <div className={resizePanelStyles.panelSeparator}>
        ...
        <div
          className={`${resizePanelStyles.panelResizable} ${
            width.right === 0 ? ` ${resizePanelStyles.magnetic}` : ''
          }`}
          style={{ maxWidth: `${width.right}%`, width: `${width.right}%` }}
        >
          {rightPanel}
        </div>
      </div>
