...
const QuestionFilter = ({ onFilter }) => {
    ...
    return (
        <Stack spacing={2} padding={2}>
            <Typography variant="body2" color="info"> Filter by text </Typography>
            ...
            <Typography variant="body2" color="info"> Filter by question type </Typography>
            <Box>
                {
                    types.map((type) => (
                        <CheckboxLabel
            ...
            { filter.questionTypes.code &&
                <>
                    <Typography variant="body2" color="info"> Filter code question by language </Typography>
                    <Box>
                        {
            ...
            <Button variant="contained" color="info" fullWidth onClick={applyFilter}> Filter </Button>
