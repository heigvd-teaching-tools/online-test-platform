...
const post = async (req, res) => {
    ...
    if(!collectionToQuestions || collectionToQuestions && collectionToQuestions.length === 0){
                            ...
                            create: {
                                ...
                                sandbox: {
                                    create: {
                                        ...
                                        beforeAll: collectionToQuestion.question.code.sandbox.beforeAll
                                    }
                                },
                                testCases: {
                                    create: collectionToQuestion.question.code.testCases.map(testCase => ({
